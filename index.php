    ...
    <section id="promo">
      <div class="container-fluid bg-light p-5">
        <div class="row text-center">
          ...
          <div class="col-12 col-sm-6 col-lg-3">
           <img src="assets/img/promo/1.webp" alt="Promo 1" class="img-fluid">
          </div>
          <div class="col-12 col-sm-6 col-lg-3">
            <img src="assets/img/promo/2.webp" alt="Promo 2" class="img-fluid">
          </div>
          <div class="col-12 col-sm-6 col-lg-3">
            <img src="assets/img/promo/3.webp" alt="Promo 3" class="img-fluid">
          </div>
          <div class="col-12 col-sm-6 col-lg-3">
            <img src="assets/img/promo/4.webp" alt="Promo 4" class="img-fluid">
        </div>
      </div>
    </section>
    ...
    <section id="contact">
      <div class="container p-5">
        ...
        <div class="col-10 col-md-4">
          ...
          <p><i class="fas fa-map-pin"></i> Jalan Aria Santika, Cimone - Tangerang</p>
          <h2 class="my-3">Contact</h2>
          <p><i class="fas fa-user"></i> Dimas Aji Permana</p>
          <p><i class="fa-brands fa-whatsapp"></i> 0896 3601 1876</p>
          <p><i class="fas fa-envelope"></i> dimasaji1111@gmail.com</p>
        </div>
        </div>
      </div>
    </section>
